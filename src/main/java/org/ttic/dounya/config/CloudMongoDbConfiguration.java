package org.ttic.dounya.config;

import com.github.mongobee.Mongobee;
import com.mongodb.Mongo;
import org.ttic.dounya.domain.util.JSR310DateConverters.*;
...
@Configuration
@EnableMongoRepositories("org.ttic.dounya.repository")
...
public class CloudMongoDbConfiguration extends AbstractMongoConfiguration  {
    ...
    public Mongobee mongobee() throws Exception {
        ...
        mongobee.setChangeLogsScanPackage("org.ttic.dounya.config.dbmigrations");
